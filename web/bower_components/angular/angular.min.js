...
(function (T, V, s) {
    ...
    function Je() {
        this.$get = function () {
            function b(b, d) {
                ...
                var g = 0, h = y({}, d, {id: b}), l = {}, k = d && d.capacity || Number.MAX_VALUE, m = {}, r = null,
                    n = null;
                return a[b] = {
                    put: function (a, b) {
    ...
    function Bc(b, a) {
        ...
        var e = {}, f = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/, g = /(([\w\-]+)(?:\:([^;]+))?;?)/,
            h = Ld("ngSrc,ngSrcset,src,srcset"), l = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, k = /^(on[a-z]+|formaction)$/;
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, d, u, p, I, R, x, M, C) {
            ...
            function Xb(a, b, c, e, f, g,
                        h, k) {
                var l = [], n, m, p = b[0], t = a.shift(),
                    x = Pb(t, {templateUrl: null, transclude: null, replace: null, $$originalDirective: t}),
    ...
    function Af(b, a, c, d, e) {
        ...
        return function (e, h, l, k, m, r, n, v) {
            ...
            if ("jsonp" == O(e)) {
                ...
                I.onload = function () {
                    var a = I.statusText || "", b = "response" in I ? I.response : I.responseText,
    ...
    function Oe() {
        this.$get = ["$rootScope", "$window", "$q", "$$q", function (b, a, c, d) {
            function e(e, h, l, k) {
                var m = a.setInterval, r = a.clearInterval, n = 0, v = B(k) && !k, t = (v ? d : c).defer(),
                    w = t.promise;
                l = B(l) ? l : 0;
                w.then(null, null, e);
    ...
    function jd(b, a, c, d, e, f, g) {
        ...
        var h = function (a) {
                return ka(a, f)
            }, l = g || Pa(b) ? h : na, k = g || Pa(a) ? h : na, m = g || Pa(c) ? h : na, r = g || Pa(d) ? h : na,
            n = g || Pa(e) ? h : na;
        return function (f, g) {
                    ...
                    do {
                        ...
                        a:do {
                            if (k = w.$$watchers) for (m = k.length; m--;) try {
                                if (b = k[m]) if ((f = b.get(w)) !== (h = b.last) &&
    ...
    function Ze() {
        this.$get = ["$window", "$document", function (b, a) {
            var c = {}, d = aa((/android (\d+)/.exec(O((b.navigator || {}).userAgent)) || [])[1]),
    ...
    function xd(b) {
        ...
        d.$setValidity = function (b, e, f) {
            ...
            d.$pending ? (a(Cd, !0), d.$valid = d.$invalid = s, c("", null)) : (a(Cd, !1), d.$valid = Bd(d.$error), d.$invalid =
                !d.$valid, c("", d.$valid));
    ...
    var Sf = /^\/(.+)\/([a-z]*)$/, O = function (b) {
        ...
        }, Qa, G, pa, Za = [].slice, uf = [].splice, Tf = [].push, Aa = Object.prototype.toString, Ja = E("ng"),
        ba = T.angular || (T.angular = {}), db, rb = 0;
    Qa = V.documentMode;
    D.$inject = [];
    na.$inject = [];
    var A =
        ...
        }, tb = ["ng-", "data-ng-", "ng:", "x-ng-"], Rd = /[A-Z]/g, zc = !1, Rb, ma = 1, ab = 3,
        Vd = {full: "1.3.17", major: 1, minor: 3, dot: 17, codeName: "tsktskskly-euouae"};
    P.expando = "ng339";
    var Ab =
        P.cache = {}, nf = 1;
    P._data = function (b) {
    ...
    var hf = /([\:\-\_]+(.))/g, jf = /^moz([A-Z])/, Uf = {mouseleave: "mouseout", mouseenter: "mouseover"},
        Ub = E("jqLite"), mf = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Tb = /<|&#?\w+;/, kf = /<([\w:]+)/,
        lf = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, ha = {
    ...
    var Uc = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Vf = /,/, Wf = /^\s*(_?)(\S+?)\1\s*$/,
        Tc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Da = E("$injector");
    ...
    var Wc = /^((?:x|data)[\:\-_])/i, vf = E("$controller"), ad = "application/json",
        cc = {"Content-Type": ad + ";charset=utf-8"}, xf = /^\[|^\{(?!\{)/, yf = {"[": /]$/, "{": /}$/},
        wf = /^\)\]\}',?\n/, dc = E("$interpolate"), Yf = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/,
        Bf = {http: 80, https: 443, ftp: 21}, Hb = E("$location"), Zf = {
    ...
    var Ff = ga(), Ef = ga(), Gf = Object.prototype.valueOf, za = E("$sce"),
        la = {HTML: "html", CSS: "css", URL: "url", RESOURCE_URL: "resourceUrl", JS: "js"}, da = E("$compile"),
        Y = V.createElement("a"), nd = ya(T.location.href);
    Ic.$inject = ["$provide"];
    od.$inject = ["$locale"];
    qd.$inject = ["$locale"];
    var td = ".", Qf = {
    ...
    var Dd = function (a) {
        ...
        }, Zd = Dd(), le = Dd(!0), Rf = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/,
        dg = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,
        eg = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i,
        fg = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Ed = /^(\d{4})-(\d{2})-(\d{2})$/,
        Fd = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, oc = /^(\d{4})-W(\d\d)$/,
        Gd = /^(\d{4})-(\d\d)$/,
    ...
    var ne = ["$animate", function (a) {
        ...
        }, ob = "ng-valid", Ad = "ng-invalid", Ra = "ng-pristine", Mb = "ng-dirty", Cd = "ng-pending",
        Ob = new E("ngModel"),
        ig = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function (a, c, d, e, f, g, h, l, k, m) {
            ...
            return {
                restrict: "EA", link: function (f, g, h) {
                    ...
                    var k = h.count, m = h.$attr.when && g.attr(h.$attr.when), r = h.offset || 0, n = f.$eval(m) || {},
                        v = {}, m = c.startSymbol(), t =
            ...
            return {
                ...
                compile: function (f, g) {
                    var h = g.ngRepeat, l = V.createComment(" end ngRepeat: " + h + " "),
                        k = h.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+track\s+by\s+([\s\S]+?))?\s*$/);
                    if (!k) throw d("iexp", h);
                    var m = k[1], r = k[2], n = k[3], v = k[4],
                ...
                link: function (e, g, h, l) {
                    ...
                    function r(e, f, g) {
                        ...
                        var y = c(u[2] || u[1]), D = u[4] || u[6], F = / as /.test(u[0]) && u[1], x = F ? c(F) :
                            null, G = u[5], J = c(u[3] || ""), C = c(u[2] ? u[1] : D), M = c(u[7]),
                            K = u[8] ? c(u[8]) : null, O = {}, P = [[{element: f, label: ""}]], T = {};
                    ...
                    if (l[1]) {
                        var n = l[0];
                        l = l[1];
                        var v = h.multiple, t = h.ngOptions, w = !1, u, p = !1, z = G(V.createElement("option")),
                            E = G(V.createElement("optgroup")), y = z.clone();
                        h = 0;
