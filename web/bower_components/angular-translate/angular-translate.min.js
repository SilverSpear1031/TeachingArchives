...
angular.module("pascalprecht.translate", ["ng"]).run(["$translate", function (a) {
    ...
    var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q = {}, r = [], s = a, t = [], u = !1, v = "translate-cloak",
        w = !1, x = ".", y = "2.4.2", z = function () {
        ...
        restrict: "AE", scope: !0, compile: function (b, g) {
            ...
            return function (b, l, m) {
                ...
                var p = function (b, c, e) {
                    ...
                    var f = a.isPostCompilingEnabled(), h = "undefined" != typeof g.translateCompile,
